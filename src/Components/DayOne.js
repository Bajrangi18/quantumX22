...
const DayOne = () => {
    ...
    return (
        <div className="container-fluid container_dayone text-light">
                ...
                <div className="div181" onMouseOver={() => {document.getElementById("PIT001").style.opacity="1.0"}} onMouseLeave={() => {document.getElementById("PIT001").style.opacity="0.0"}}> <center><button type="button" class="btn btn-light" id="PIT001">IDEAS2FUND</button></center></div>
                ...
                <div className="div201" onMouseOver={() => {document.getElementById("IDE001").style.opacity="1.0"}} onMouseLeave={() => {document.getElementById("IDE001").style.opacity="0.0"}}> <center><button type="button" class="btn btn-light" id="IDE001">IDEASTORM</button></center></div>
