...
const DayTwo = () => {
    return (
        <div className="container-fluid container_daytwo text-light">
            ...
            <div className="div152"> </div>
            <div className="div162"> </div>
            <div className="div172"> </div>
            <div className="div182"> </div>
            <div className="div192"> </div>
            <div className="div202"> </div>
            <div className="div212"> </div>
            <div className="div222"> </div>
            <div className="div232"> </div>
            <div className="div242"> </div>
            <div className="div252"> </div>
            <div className="div262"> </div>
        </div>
    );
}
